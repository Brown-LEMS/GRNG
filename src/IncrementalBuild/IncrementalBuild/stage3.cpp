 ...
 * @param queryStruct
 */
void IncrementalBuild::stage3_multithreading(QueryStructIncrementalBuild& queryStruct) {
 ...
 * @param queryStruct
 */
void IncrementalBuild::stage3(QueryStructIncrementalBuild& queryStruct) {
    std::chrono::high_resolution_clock::time_point tStart_stage = std::chrono::high_resolution_clock::now();
    unsigned long long int const dStart_stage = get_distanceComputationCount();
