#ifndef QueryStructOnlineSearch_hpp
#define QueryStructOnlineSearch_hpp
/*
...
/**
 * @brief Struct to hold all temporary datastructures for individual query during OnlineSearch
 *
 */
struct QueryStructOnlineSearch {
  public:
    QueryStructOnlineSearch(){};
    QueryStructOnlineSearch(int const pivotLayerIndex, unsigned int const queryIndex, float const queryRadius)
    ...
    // maps for each layer
    tsl::sparse_map<int, tsl::sparse_set<unsigned int>> ancestorIndicesMap = tsl::sparse_map<int, tsl::sparse_set<unsigned int>>{};
    tsl::sparse_map<int, tsl::sparse_set<unsigned int>> pivotLayerNeighborsListMap = tsl::sparse_map<int, tsl::sparse_set<unsigned int>>{};
...
#endif  // QueryStructOnlineSearch_hpp