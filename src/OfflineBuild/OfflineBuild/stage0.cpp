 ...
 * @param queryStruct
 */
void OfflineBuild::stage0(QueryStructOfflineBuild& queryStruct) {
    ...
    if (coarserLayerIndex == 0) {
        ...
        tsl::sparse_set<unsigned int> const& topLayerPivotIndices =
            *(*_pivotLayers)[coarserLayerIndex].get_pivotIndices_ptr();
