...
void Test_OfflineBuild::test_familyTree() {
...
void Test_OfflineBuild::test_dmax() {
...
void Test_OfflineBuild::test_umax() {
...
void Test_OfflineBuild::test_neighbors() {
    std::cout << "Unit Test: Neighbors" << std::endl;

    // create dataset
    unsigned int const datasetSize = 3200;
    unsigned int const dimension = 2;
    float* dataPointer;
    Datasets::uniformDataset(dataPointer, dimension, datasetSize, 3);
...
void Test_OfflineBuild::test_coarseNeighbors() {
