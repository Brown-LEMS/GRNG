...
int main(int argc, char** argv) {
    ...
    float build_time4 = 0;
    hacid::approximateRNG(dataPointer, datasetSize, dimension, epsilon, numThreads, RNG_neighbors4, build_distanceComputations4, build_time4);
    ...
    if (GT) {
        ...
        // construct brute force rng
        verification::bruteForceRNG(dataPointer, datasetSize, dimension, numThreads, GT_RNG_neighbors, GT_build_distanceComputations, GT_build_time);
        printf("Naive RNG | Time: %.3f, Distances: %u\n", GT_build_time, GT_build_distanceComputations);
    }
    ...
    float search_distanceComputations4 = 0;
    float search_time4 = 0;
    hacid::search(dimension, dataPointer, datasetSize, testPointer, testsetSize, epsilon, numThreads, RNG_neighbors4,
